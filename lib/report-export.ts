...
export function buildReportRows(snapshot: AnalyticsSnapshot): ReportRow[] {
  return [
    ...
    { section: "KPI", label: "Usuarios activos", value: formatNumber(snapshot.kpis.activeUsers) },
...
export function buildPdfReport(snapshot: AnalyticsSnapshot) {
  ...
  cardGrid([
    ...
    { label: "Usuarios", value: formatNumber(snapshot.kpis.activeUsers), detail: "Compradores activos" },
